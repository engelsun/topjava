...
public class MealsUtil {
    ...
    public static List<MealWithExceed> getWithExceeded(Collection<Meal> meals, int caloriesLimitPerDay) {
        return getFilteredWithExceeded(meals, LocalTime.MIN, LocalTime.MAX, caloriesLimitPerDay);
    }
